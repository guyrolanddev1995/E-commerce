                    ...
                    <li class="pr-0">
                        <div class="dropdown">
                            <button type="button" id="dropdownMenuButton-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{ asset('assets/images/flag/1.jpg') }}" alt="" /> English <i class="ion-ios-arrow-down"></i>
                            </button>

                            <ul class="dropdown-menu animation slideDownIn" aria-labelledby="dropdownMenuButton-3">
                                <li>
                                    <a href="#"><img src="{{ asset('assets/images/flag/1.jpg') }}" alt="" /> English</a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/images/flag/2.jpg') }}" alt="" /> Français</a>
                                </li>
                            </ul>
                        </div>
                    </li>
